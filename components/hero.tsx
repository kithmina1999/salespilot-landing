      ...
      <div className="mx-auto max-w-5xl px-5 text-center relative z-10 mb-32">
        <div ref={textRef} className="flex flex-col items-center">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <Link href={appRegisterUrl} className="inline-flex items-center justify-center gap-2 rounded-full bg-emerald-600 px-8 py-4 text-sm font-black text-white shadow-lg shadow-emerald-600/20 transition hover:bg-emerald-700 hover:shadow-emerald-600/30 hover:-translate-y-0.5">
              {t.primary}
